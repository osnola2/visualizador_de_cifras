const chordData = {
    "F6/9/11+": {"name": "F6/9/11+", "notes": ["F3", "A3", "C4", "D4", "G4", "B4"], "displayNotes": ["F", "A", "C", "D", "G", "B"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth", "alt"]},
    "D7": {"name": "D7", "notes": ["D3", "F#3", "A3", "C4"], "displayNotes": ["D", "F#", "A", "C"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    "E5-/7": {"name": "E5-/7", "notes": ["E3", "G3", "B3", "D4"], "displayNotes": ["E", "G", "B", "D"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    "Db7/9": {"name": "Db7/9", "notes": ["C#3", "F3", "G#3", "B3", "D#4"], "displayNotes": ["Db", "F", "Ab", "B", "Eb"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth"]},
    "Eb7": {"name": "Eb7", "notes": ["D#3", "G3", "A#3", "C#4"], "displayNotes": ["Eb", "G", "Bb", "Db"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    "C#/D#": {"name": "C#/D#", "notes": ["D#3", "C#4", "F4", "G#4"], "displayNotes": ["D#", "C#", "F", "G#"], "noteTypes": ["bass", "root", "triad", "triad"]},
    "D#7": {"name": "D#7", "notes": ["D#3", "G3", "A#3", "C#4"], "displayNotes": ["D#", "G", "A#", "C#"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    "Eb4/7": {"name": "Eb4/7", "notes": ["D#3", "G3", "A#3", "C#4"], "displayNotes": ["Eb", "G", "Bb", "Db"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    "A7/11+": {"name": "A7/11+", "notes": ["A3", "C#4", "E4", "G4", "B4", "D#5"], "displayNotes": ["A", "C#", "E", "G", "B", "D#"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth", "alt"]},
    "Bbm7": {"name": "Bbm7", "notes": ["A#3", "C#4", "F4", "G#4"], "displayNotes": ["Bb", "Db", "F", "Ab"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    ...
    "C/D": {"name": "C/D", "notes": ["D3", "C4", "E4", "G4"], "displayNotes": ["D", "C", "E", "G"], "noteTypes": ["bass", "root", "triad", "triad"]},
    "E6/9/11+": {"name": "E6/9/11+", "notes": ["E3", "G#3", "B3", "C#4", "F#4", "A#4"], "displayNotes": ["E", "G#", "B", "C#", "F#", "A#"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth", "alt"]},
    "B/C#": {"name": "B/C#", "notes": ["C#3", "B3", "D#4", "F#4"], "displayNotes": ["C#", "B", "D#", "F#"], "noteTypes": ["bass", "root", "triad", "triad"]},
    "C#6/9/11+": {"name": "C#6/9/11+", "notes": ["C#3", "F3", "G#3", "A#3", "D#4", "G4"], "displayNotes": ["C#", "F", "G#", "A#", "D#", "G"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth", "alt"]},
    "Bb7/11+": {"name": "Bb7/11+", "notes": ["A#3", "D4", "F4", "G#4", "C5", "E5"], "displayNotes": ["Bb", "D", "F", "Ab", "C", "E"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth", "alt"]},
    "G/A": {"name": "G/A", "notes": ["A3", "G4", "B4", "D5"], "displayNotes": ["A", "G", "B", "D"], "noteTypes": ["bass", "root", "triad", "triad"]},
    "D#4/7": {"name": "D#4/7", "notes": ["D#3", "G3", "A#3", "C#4"], "displayNotes": ["D#", "G", "A#", "C#"], "noteTypes": ["root", "triad", "triad", "seventh"]},
};
