const chordData = {
    ...
    "A7/11+": {
        name: "A7/11+",
        notes: ["C3", "A3", "C#4", "E4", "G4"],
        displayNotes: ["C", "A", "C#", "E", "G"],
    ...
    "B/C#": {
        name: "B/C#",
        notes: ["C#3", "B3", "D#4", "F#4"],
        displayNotes: ["C#", "B", "D#", "F#"],
        noteTypes: ["bass", "root", "triad", "triad"]
    },
    "Bb7/11+": {
        name: "Bb7/11+",
        notes: ["C3", "A#3", "D4", "F4", "G#4"],
        displayNotes: ["C", "Bb", "D", "F", "Ab"],
        noteTypes: ["bass", "root", "triad", "triad", "seventh"]
    },
    "Bbm7": {
        name: "Bbm7",
        notes: ["A#3", "C#4", "F4", "G#4"],
        displayNotes: ["Bb", "Db", "F", "Ab"],
        noteTypes: ["root", "triad", "triad", "seventh"]
    },
    "C#/D#": {
        name: "C#/D#",
        notes: ["D#3", "C#4", "F4", "G#4"],
        displayNotes: ["D#", "C#", "F", "G#"],
        noteTypes: ["bass", "root", "triad", "triad"]
    },
    "C#6/9/11+": {
        name: "C#6/9/11+",
        notes: ["C3", "C#3", "F3", "G#3"],
        displayNotes: ["C", "C#", "F", "G#"],
        noteTypes: ["bass", "root", "triad", "triad"]
    },
    "C/D": {
        name: "C/D",
        notes: ["D3", "C4", "E4", "G4"],
        displayNotes: ["D", "C", "E", "G"],
        noteTypes: ["bass", "root", "triad", "triad"]
    },
    "D#4/7": {
        name: "D#4/7",
        notes: ["C3", "D#3", "G3", "A#3"],
        displayNotes: ["C", "D#", "G", "A#"],
        noteTypes: ["bass", "root", "triad", "triad"]
    },
    "D#7": {
        name: "D#7",
        notes: ["D#3", "G3", "A#3", "C#4"],
        displayNotes: ["D#", "G", "A#", "C#"],
        noteTypes: ["root", "triad", "triad", "seventh"]
    },
    "D7": {
        name: "D7",
    ...
    "Db7/9": {
        name: "Db7/9",
        notes: ["C3", "C#3", "F3", "G#3", "B3"],
        displayNotes: ["C", "Db", "F", "Ab", "B"],
        noteTypes: ["bass", "root", "triad", "triad", "seventh"]
    },
    "E5-/7": {
        name: "E5-/7",
    ...
    "F6/9/11+": {
        name: "F6/9/11+",
        notes: ["C3", "F3", "A3", "C4"],
        displayNotes: ["C", "F", "A", "C"],
        noteTypes: ["bass", "root", "triad", "triad"]
    },
    "G/A": {
        name: "G/A",
        notes: ["A3", "G4", "B4", "D5"],
        displayNotes: ["A", "G", "B", "D"],
        noteTypes: ["bass", "root", "triad", "triad"]
    }
};
