const chordData = {
    "B7(9)": {"name": "B7(9)", "notes": ["B3", "D#4", "F#4", "A4", "C#5"], "displayNotes": ["B", "D#", "F#", "A", "C#"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth"]},
    "B6(9)/F": {"name": "B6(9)/F", "notes": ["F3", "B3", "D#4", "F#4", "G#4", "C#5"], "displayNotes": ["F", "B", "D#", "F#", "G#", "C#"], "noteTypes": ["bass", "root", "triad", "triad", "seventh", "ninth"]},
    "B/A": {"name": "B/A", "notes": ["A3", "B3", "D#4", "F#4"], "displayNotes": ["A", "B", "D#", "F#"], "noteTypes": ["bass", "root", "triad", "triad"]},
    "Em6": {"name": "Em6", "notes": ["E3", "G3", "B3", "C#4"], "displayNotes": ["E", "G", "B", "C#"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    "Bm7": {"name": "Bm7", "notes": ["B3", "D4", "F#4", "A4"], "displayNotes": ["B", "D", "F#", "A"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    "F/D#": {"name": "F/D#", "notes": ["D#3", "F3", "A3", "C4"], "displayNotes": ["Eb", "F", "A", "C"], "noteTypes": ["bass", "root", "triad", "triad"]},
    "B6(9)": {"name": "B6(9)", "notes": ["B3", "D#4", "F#4", "G#4", "C#5"], "displayNotes": ["B", "D#", "F#", "G#", "C#"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth"]},
    "Bb9/F": {"name": "Bb9/F", "notes": ["F3", "A#3", "D4", "F4", "G#4", "C5"], "displayNotes": ["F", "Bb", "D", "F", "Ab", "C"], "noteTypes": ["bass", "root", "triad", "triad", "seventh", "ninth"]},
    "B": {"name": "B", "notes": ["B3", "D#4", "F#4"], "displayNotes": ["B", "D#", "F#"], "noteTypes": ["root", "triad", "triad"]},
    "C/B": {"name": "C/B", "notes": ["B3", "C4", "E4", "G4"], "displayNotes": ["B", "C", "E", "G"], "noteTypes": ["bass", "root", "triad", "triad"]},
    "G#m6": {"name": "G#m6", "notes": ["G#3", "B3", "D#4", "F4"], "displayNotes": ["G#", "B", "D#", "F"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    "F#m7": {"name": "F#m7", "notes": ["F#3", "A3", "C#4", "E4"], "displayNotes": ["F#", "A", "C#", "E"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    "D#/B": {"name": "D#/B", "notes": ["B3", "D#4", "G4", "A#4"], "displayNotes": ["B", "D#", "G", "A#"], "noteTypes": ["bass", "root", "triad", "triad"]},
    "B7": {"name": "B7", "notes": ["B3", "D#4", "F#4", "A4"], "displayNotes": ["B", "D#", "F#", "A"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    "B7M(9)": {"name": "B7M(9)", "notes": ["B3", "D#4", "F#4", "A#4", "C#5"], "displayNotes": ["B", "D#", "F#", "A#", "C#"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth"]},
    "F7(11+)": {"name": "F7(11+)", "notes": ["F3", "A3", "C4", "D#4", "G4", "B4"], "displayNotes": ["F", "A", "C", "Eb", "G", "B"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth", "alt"]},
    "D/C": {"name": "D/C", "notes": ["C3", "D3", "F#3", "A3"], "displayNotes": ["C", "D", "F#", "A"], "noteTypes": ["bass", "root", "triad", "triad"]},
    "B7M(9)/F#": {"name": "B7M(9)/F#", "notes": ["F#3", "B3", "D#4", "F#4", "A#4", "C#5"], "displayNotes": ["F#", "B", "D#", "F#", "A#", "C#"], "noteTypes": ["bass", "root", "triad", "triad", "seventh", "ninth"]},
    "B6": {"name": "B6", "notes": ["B3", "D#4", "F#4", "G#4"], "displayNotes": ["B", "D#", "F#", "G#"], "noteTypes": ["root", "triad", "triad", "seventh"]},
    "Em6/G": {"name": "Em6/G", "notes": ["G3", "E4", "G4", "B4", "C#5"], "displayNotes": ["G", "E", "G", "B", "C#"], "noteTypes": ["bass", "root", "triad", "triad", "seventh"]},
    "E7M(13)": {"name": "E7M(13)", "notes": ["E3", "G#3", "B3", "D#4", "F#4", "C#5"], "displayNotes": ["E", "G#", "B", "D#", "F#", "C#"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth", "alt"]},
    "B7(13)": {"name": "B7(13)", "notes": ["B3", "D#4", "F#4", "A4", "C#5", "G#5"], "displayNotes": ["B", "D#", "F#", "A", "C#", "G#"], "noteTypes": ["root", "triad", "triad", "seventh", "ninth", "alt"]},
};
