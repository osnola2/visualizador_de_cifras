...
(function (global, factory) {
    ...
    const CHORD_SHAPES = {
        ...
        'C7M': { frets: [5, 4, 5, 5], baseFret: 3 },
        'D7M': { frets: [0, 2, 2, 4], baseFret: 1 },
        'E7M': { frets: [2, 1, 0, 1], baseFret: 1 },
        'F7M': { frets: [3, 2, 1, 2], baseFret: 1 },
        'G7M': { frets: [5, 4, 3, 4], baseFret: 3 },
